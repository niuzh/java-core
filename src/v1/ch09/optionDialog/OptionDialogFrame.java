	...
	*/
	public Object[] getOptions() {
		...
		if (s.equals("String[]"))
			...
			return new Icon[] { new ImageIcon("src/v1/ch09/yellow-ball.gif"), new ImageIcon("src/v1/ch09/blue-ball.gif"), new ImageIcon("src/v1/ch09/red-ball.gif") };
		else if (s.equals("Object[]"))
			return new Object[] { messageString, messageIcon, messageComponent, messageObject };
		else
			return null;
