...
public class TestDB {
	...
	public static Connection getConnection() throws SQLException, IOException {
		...
		String path = "/home/niu/workspace/java-core9/src/v2/ch04/test";
		try (InputStream in = Files.newInputStream(Paths.get(path, "database.properties"))) {
			props.load(in);
		}
