...
/**
 * This frame shows a tabbed pane and radio buttons to switch between wrapped
 * and scrolling tab layout.
 */
public class TabbedPaneFrame extends JFrame {
	...
	public TabbedPaneFrame() {
		...
		// we set the components to null and delay their loading until the tab
		// is shown
		// for the first time
