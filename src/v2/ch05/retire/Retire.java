...
import v2.ch05.numberFormat.GBC;
...
class RetireFrame extends JFrame {
	...
	public void setCurrentLocale(Locale locale) {
		...
		res = ResourceBundle.getBundle("v2.ch05.retire.RetireResources", currentLocale);
		resStrings = ResourceBundle.getBundle("v2.ch05.retire.RetireStrings", currentLocale);
...
class RetireInfo {
	 ...
	 * 
	 * @param year
	 *            the year for which to compute the balance
